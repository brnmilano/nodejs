...
connection
  // .sync()
  .sync({ force: true }) // O método sync é usado para sincronizar o modelo com o banco de dados,
  // criando a tabela correspondente se ela ainda não existir. O parâmetro force: true é usado
  // para forçar a recriação da tabela, o que significa que a tabela será excluída e recriada toda
  // vez que o aplicativo for iniciado. Isso é útil durante o desenvolvimento para garantir que as
  // alterações no modelo sejam refletidas no banco de dados, mas deve ser usado com cuidado em
  // ambientes de produção, pois pode resultar na perda de dados.
  .then(() => {
